...
public class EmpDetailVO {
     ...
     * 员工头像文件路径
     */
    private String avatarDocUrl;

    /**
     * 员工身份文件
     */
    private List<FileVO> idCardDocList;

    /**
     * 员工学历文件
     *
     */
    private List<FileVO> educateDocList;

    /**
     * 员工职称文件
     */
    private List<FileVO> paperDocList;

    /**
     * 员工档案文件
     */
    private List<FileVO> recordDocList;

    /**
     * 员工其他文件
     */
    private List<FileVO> otherDocList;
