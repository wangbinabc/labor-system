...
@Component
public class EmpHistoryExcelImportVerifyHandler implements IExcelVerifyHandler<EmpImportVO> {
...
//    private ISysDictTypeService dictTypeService;
    ...
    public ExcelVerifyHandlerResult verifyHandler(EmpImportVO empImport) {
        ...
        List<SysDictData> empStatusDicDateInfos = dictDataMapper.selectDictDataByType("emp_status");
        if (empImport.getEmpStatus() != null) {
            List<String> empStatusDicInfos = empStatusDicDateInfos.
...
//        }
        ...
        String expireLabel = null;
        for (SysDictData statusDicDateInfo : empStatusDicDateInfos) {
            String dictValue = statusDicDateInfo.getDictValue();
            if (expireKey.equals(dictValue)) {
                expireLabel = statusDicDateInfo.getDictLabel();
            }
        }
        if (expireLabel != null && expireLabel.equals(empStatus)) {
