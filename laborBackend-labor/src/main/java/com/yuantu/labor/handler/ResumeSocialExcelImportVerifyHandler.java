...
import com.yuantu.labor.vo.ResumeSocialImportVO;
import com.yuantu.labor.vo.ResumeSocialTemplateVO;
...
@Component
public class ResumeSocialExcelImportVerifyHandler implements IExcelVerifyHandler<ResumeSocialImportVO> {
    ...
    @Override
    public ExcelVerifyHandlerResult verifyHandler(ResumeSocialImportVO resume) {
