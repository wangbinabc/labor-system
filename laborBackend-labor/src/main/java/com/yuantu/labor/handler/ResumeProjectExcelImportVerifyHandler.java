...
@Component
public class ResumeProjectExcelImportVerifyHandler implements IExcelVerifyHandler<ResumeProjectImportVO> {
    ...
    @Override
    public ExcelVerifyHandlerResult verifyHandler(ResumeProjectImportVO resume) {
